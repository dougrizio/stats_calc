...
class MyTestCase(unittest.TestCase):
    ...
    def test_subtraction(self):
        test_subtraction_data = MyTestCase.CsvReader('/Tests/ut_subtraction.csv')
    ...
    def test_multiplication(self):
        test_multiplication_data = MyTestCase.CsvReader('/Tests/ut_multiplication.csv')
    ...
    def test_squaring(self):
        test_squaring_data = MyTestCase.CsvReader('/Tests/ut_squaring.csv')
    ...
    def test_squarerooting(self):
        test_squarerooting_data = MyTestCase.CsvReader('/Tests/ut_squarerooting.csv')
